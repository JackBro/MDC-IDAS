...
IMPLEMENT_DYNAMIC(CDlgChild8_2, CDialog)

CDlgChild8_2::CDlgChild8_2(CWnd* pParent /*=NULL*/)	: CDialog(CDlgChild8_2::IDD, pParent)
{
	m_strName = L"ZTE_MDC_Data:\\王小明";
}

CDlgChild8_2::~CDlgChild8_2()
{
}

void CDlgChild8_2::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgChild8_2, CDialog)
END_MESSAGE_MAP()


BOOL CDlgChild8_2::OnInitDialog()
{
