...
IMPLEMENT_DYNAMIC(CDlgChild8_1_1, CDialog)

CDlgChild8_1_1::CDlgChild8_1_1(CWnd* pParent /*=NULL*/)	: CDialog(CDlgChild8_1_1::IDD, pParent)
{
	m_strName = L"ZTE_MDC_Data:\\王小明";
}

CDlgChild8_1_1::~CDlgChild8_1_1()
{
}

void CDlgChild8_1_1::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgChild8_1_1, CDialog)
END_MESSAGE_MAP()


BOOL CDlgChild8_1_1::OnInitDialog()
{
